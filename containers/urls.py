from containers.views import ContainerImagesView, ContainerListView, ContainerLogsView, ContainerRestartView, ContainerStartView, ContainerStopView
...
path("images/", ContainerImagesView.as_view()),
